...
final class CandyEULA {
    
    static var termsAndConditions: String {
        return """
        This End-User License Agreement (this "EULA") is a legal agreement between you ("Licensee") and Erik Perez ("Licensor"), the author of Candy, including all HTML files, XML files, Java files, Swift files, graphics files, animation files, data files, technology, development tools, scripts and programs, both in object code and source code (the "Software"), the deliverables provided pursuant to this EULA, which may include associated media, printed materials, and "online" or electronic documentation.
        By installing, copying, or otherwise using the Software, Licensee agrees to be bound by the terms and conditions set forth in this EULA. If Licensee does not agree to the terms and conditions set forth in this EULA, then Licensee may not use the Software.
        ...
        5. Support. Licensor will provide on site support, available during normal business hours for a time period of 3 years.
        ...
        14. Additional Provisions and/or Disclosures. There is no tolerance for objectionable content or abusive users.
"""
    }
}
